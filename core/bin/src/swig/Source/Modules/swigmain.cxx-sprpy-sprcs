...
extern "C" {
  ...
  Language *swig_spr(void);
  Language *swig_sprpy(void);
//  Language *swig_sprcli(void);
  Language *swig_sprcs(void);
  Language *swig_dll(void);
}
...
static swig_module modules[] = {
  ...
  {"-xml", swig_xml, "XML"},
  {"-spr", swig_spr, "Springhead"},
  {"-sprpy", swig_sprpy, "SpringheadPython"},
//  {"-sprcli", swig_sprcli, "Springhead C++/CLI"},
  {"-sprcs", swig_sprcs, "SpringheadCSharp"},
  {"-dll", swig_dll, "Dll entery point"},
  {NULL, NULL, NULL}
};
