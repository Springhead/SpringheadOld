...
enum SprClassType{
	...
	SPR_CLASSTYPE_IF,		//PHSolidIfÇ»Ç«
	SPR_CLASSTYPE_DESC,		//PHSolidDescÇ»Ç«
	SPR_CLASSTYPE_STATE,	//PHSolidStateÇ»Ç«
	SPR_CLASSTYPE_NOTSPR	//int,char,PyObjectÇ»Ç«
};
...
{	
	...
	bool isInherited;
	bool isStruct;
	bool isUTRef;//UTRefÇåpè≥ÇµÇƒÇ¢ÇÈÇ©Ç«Ç§Ç©
