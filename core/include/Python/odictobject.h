...
PyAPI_FUNC(PyObject *) __PYDECL  PyODict_New(void);
PyAPI_FUNC(int) __PYDECL  PyODict_SetItem(PyObject *od, PyObject *key, PyObject *item);
PyAPI_FUNC(int) __PYDECL  PyODict_DelItem(PyObject *od, PyObject *key);
