...
PyAPI_FUNC(Py_hash_t) __PYDECL  _Py_HashDouble(double);
PyAPI_FUNC(Py_hash_t) __PYDECL  _Py_HashPointer(void*);
PyAPI_FUNC(Py_hash_t) __PYDECL  _Py_HashBytes(const void*, Py_ssize_t);
#endif
...
PyAPI_FUNC(PyHash_FuncDef*) __PYDECL  PyHash_GetFuncDef(void);
#endif
