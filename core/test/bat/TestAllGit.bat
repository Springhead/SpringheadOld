...
rem echo.  [DATE_LOG]: %DATE_LOG%

if exist %RESULT_LOG% del %RESULT_LOG%
if exist %DATE_LOG% del %DATE_LOG%
...
if %$status% == 0 (
	...
	echo This file was generated by "TestAllGit.bat".		>  %DATE_LOG%
	echo Format of next line: "any any any (YYYY-MMDD hh:mm:ss)".	>> %DATE_LOG%
	echo any any any ^(!DATESTR! !TIMESTR!^)			>> %DATE_LOG%
