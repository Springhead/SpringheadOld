...
set ENVMAIN2=%PREFIX%EXECUTE_MAKEDOC %PREFIX%COPYTO_WEBBASE %PREFIX%MAKE_ARCHIVE
rem for TestALL.bat
set ENVTEST1=%PREFIX%EXECUTE_STUBBUILD %PREFIX%EXECUTE_BUILDRUN %PREFIX%EXECUTE_SAMPLEBUILD
set ENVTEST2=%PREFIX%COPYTO_TAGS %PREFIX%COMMIT_BUILDLOG %PREFIX%COPYTO_BUILDLOG
::
