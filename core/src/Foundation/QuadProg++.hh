...
namespace Spr {
	...
	double solve_quadprog(PTM::VMatrixRow<double>& G, PTM::VVector<double>& g0,
		const PTM::VMatrixRow<double>& CE, const PTM::VVector<double>& ce0,
		const PTM::VMatrixRow<double>& CI, const PTM::VVector<double>& ci0,
