...
\def\SprTop#1{\Parh{C:/Springhead#1}}
\def\build{{\it{build\/}}}

\def\CMakeLists{\Path{CMakeLists.txt}}
\def\CMakeListsDev{\Path{CMakeLists.txt}}
\def\CMakeOpts{\Path{CMakeOpts.txt}}
\def\CMakeTopdir{\Path{CMakeTopdir.txt}}
